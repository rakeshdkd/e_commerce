  ...
  return (
    <>
      ...
      <Card>
        ...
        <Card.Body style={{ width: "70%", margin: "auto", border: "none" }}>
          <Card.Title
            style={{
              display: "flex",
              justifyContent: "center",
          ...
          <Card.Text>
            <img
              ...
              height="200px "
              width="200px"
              style={{ float: "left", borderRadius: "50%", margin: "40px" }}
            ></img>
            ...
            we are accusing him? Him whom something large cisterns. Lorem ipsum
            carrots enhanced rebates. Excellent sayings of a man of sorrows,
            hates no prosecutors will unfold in the enduring of which were born
            in it? Often leads smallest mistake some pain main responsibilities
            are to stand for the right builder of pleasure, accepted explain up
            to now. , The things we are accusing of these in the explication of
            the truth receives from the flattery of her will never be the
            trouble and they are refused to the pleasures and the pleasures of
            the pain, explain the treatment of excepturi of the blessed
